    ...
    <div class="container">
        ...
        <div class="row about_blog">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 about_feature_img padding_right_0">
                <div class="full text_align_center"><img class="img-responsive" src="../images/it_service/post-06.jpg"
                                                         alt="#"/></div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="full">
                    <div class="contact_us_section">
                        ...
                        <div class="button_Section_cont"><a class="btn dark_gray_bt" href="it_contact.html">Contact
                                us</a></div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="footer-menu">
                            <li><a href="about.nl.inc.php"><i class="fa fa-angle-right"></i> About us</a></li>
