                    ...
                    <ul>
                        <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7"
                            ...
                            <div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 style="z-index: 6; white-space: nowrap;"><?php echo $slides[1]['a'] ?></div>
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 data-splitout="none"
                                 data-responsive_offset="on"
                                 style="z-index: 7; white-space: nowrap;"><?php echo $slides[1]['b'] ?></div>
                        </li>
                        <li data-index="rs-181" data-transition="zoomin" data-slotamount="7"
                            ...
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 data-responsive_offset="on"
                                 data-elementdelay="0.05"
                                 style="z-index: 6; white-space: nowrap;"><?php echo $slides[2]['a'] ?></div>
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 data-splitout="none"
                                 data-responsive_offset="on"
                                 style="z-index: 7; white-space: nowrap;"><?php echo $slides[2]['b'] ?></div>
                        </li>
                        <li data-index="rs-18" data-transition="zoomin" data-slotamount="7"
                            ...
                            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                                 ...
                                 data-responsive_offset="on"
                                 data-elementdelay="0.05"
                                 style="z-index: 6; white-space: nowrap;"><?php echo $slides[3]['a'] ?></div>
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                 id="slide-18-layer-4"
                                 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                 ...
                                 data-splitout="none"
                                 data-responsive_offset="on"
                                 style="z-index: 7; white-space: nowrap;"><?php echo $slides[3]['b'] ?></div>
                        </li>
                    </ul>
                                    ...
                                    <div class="panel-heading">
                                        <p class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                                ...
                                                Data herstel harde schijven, geheugenkaarten en usbsticks.
